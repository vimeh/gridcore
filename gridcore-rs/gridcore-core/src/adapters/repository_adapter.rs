...
mod tests {
    ...
    fn test_repository_adapter_insert_row() {
        ...
        assert_eq!(adapter.get(&CellAddress::new(0, 0)).unwrap().get_computed_value(), CellValue::Number(1.0));
        assert_eq!(adapter.get(&CellAddress::new(0, 1)), None); // Empty row
        assert_eq!(adapter.get(&CellAddress::new(0, 2)).unwrap().get_computed_value(), CellValue::Number(2.0));
        assert_eq!(adapter.get(&CellAddress::new(0, 3)).unwrap().get_computed_value(), CellValue::Number(3.0));
    }
    ...
    fn test_repository_adapter_delete_row() {
        ...
        // Check cells moved correctly
        assert_eq!(adapter.get(&CellAddress::new(0, 0)).unwrap().get_computed_value(), CellValue::Number(1.0));
        assert_eq!(adapter.get(&CellAddress::new(0, 1)).unwrap().get_computed_value(), CellValue::Number(3.0));
