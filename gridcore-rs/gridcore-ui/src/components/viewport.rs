...
impl Viewport {
    ...
    pub fn get_total_rows(&self) -> usize {
        self.controller.borrow().config().total_rows
    }

    pub fn get_total_cols(&self) -> usize {
        self.controller.borrow().config().total_cols
    }
    ...
    pub fn get_scroll_position(&self) -> ScrollPosition {
        self.controller.borrow().viewport().get_scroll_position()
    }

    pub fn get_viewport_width(&self) -> f64 {
        self.controller.borrow().viewport().get_viewport_width()
    }

    pub fn get_viewport_height(&self) -> f64 {
        self.controller.borrow().viewport().get_viewport_height()
    }
    ...
    pub fn get_column_width(&self, col: usize) -> f64 {
        self.controller.borrow().viewport().get_column_width(col)
    }
    ...
    pub fn get_row_height(&self, row: usize) -> f64 {
        self.controller.borrow().viewport().get_row_height(row)
    }
    ...
    pub fn get_visible_bounds(&self) -> ViewportBounds {
        self.controller.borrow().viewport().get_visible_bounds()
    }
    ...
    pub fn get_column_x(&self, col: usize) -> f64 {
        self.controller.borrow().viewport().get_column_x(col)
    }

    pub fn get_row_y(&self, row: usize) -> f64 {
        self.controller.borrow().viewport().get_row_y(row)
    }

    pub fn get_total_grid_width(&self) -> f64 {
        self.controller.borrow().viewport().get_total_grid_width()
    }

    pub fn get_total_grid_height(&self) -> f64 {
        self.controller.borrow().viewport().get_total_grid_height()
    }
}
