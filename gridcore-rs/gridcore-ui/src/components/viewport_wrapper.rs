...
impl ViewportWrapper {
    ...
    pub fn get_cell_position(&self, address: &CellAddress) -> gridcore_controller::controller::CellPosition {
    ...
    pub fn scroll_by(&mut self, delta_x: f64, delta_y: f64) {
        self.viewport_manager.borrow_mut().scroll_by(delta_x, delta_y);
    }
    ...
    pub fn set_viewport_size(&mut self, width: f64, height: f64) {
        self.viewport_manager.borrow_mut().set_viewport_size(width, height);
    }
    ...
    pub fn set_column_width(&mut self, col: usize, width: f64) {
        self.viewport_manager.borrow_mut().set_column_width(col, width);
    }
    ...
    pub fn set_row_height(&mut self, row: usize, height: f64) {
        self.viewport_manager.borrow_mut().set_row_height(row, height);
    }
