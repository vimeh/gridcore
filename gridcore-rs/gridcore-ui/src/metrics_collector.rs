...
impl MetricsCollector {
    ...
    pub fn collect_snapshot(&self) -> MetricsSnapshot {
        ...
        *self.last_snapshot_time.borrow_mut() = current_time;
        ...
        // Calculate rates
        let formula_eval_rate = self.calculate_rate("formula_eval", formula_evaluations, time_delta);
        ...
        let action_dispatch_rate = self.calculate_rate("action_dispatch", action_dispatches, time_delta);
