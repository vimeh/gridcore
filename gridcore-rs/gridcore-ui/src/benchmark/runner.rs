...
impl UIBenchmarkRunner {
    ...
    pub fn run_scenario(&mut self, scenario: &mut Box<dyn BenchmarkScenario>) -> Vec<BenchmarkResult> {
        ...
        // Warmup phase
        leptos::logging::log!("Running {} warmup iterations...", self.config.warmup_iterations);
        ...
        // Measurement phase
        leptos::logging::log!("Running {} measurement iterations...", self.config.measurement_iterations);
    ...
    pub fn run_all(&mut self) -> BenchmarkReport {
        ...
        leptos::logging::log!("Starting benchmark suite with {} scenarios", self.scenarios.len());
    ...
    fn merge_metrics(&self, mut base: BenchmarkMetrics, profile: BenchmarkMetrics) -> BenchmarkMetrics {
        // Merge frame times
        ...
        if !profile.interaction_latencies.is_empty() {
            base.interaction_latencies.extend(profile.interaction_latencies);
        }
