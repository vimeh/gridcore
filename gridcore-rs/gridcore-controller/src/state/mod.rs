...
pub use spreadsheet::{
    ...
    is_visual_mode, BulkOperationStatus, CellMode, DeleteType, EditMode, InsertMode, InsertPosition,
    InsertType, ModalData, ModalKind, ParsedBulkCommand, ResizeMoveDirection, ResizeSizes, ResizeTarget,
    Selection, SelectionType, SpreadsheetMode, SpreadsheetVisualMode, UIState, ViewportInfo, VisualMode,
};
