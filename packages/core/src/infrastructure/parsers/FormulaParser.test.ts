  ...
  describe("tokenize", () => {
    test("tokenizes numbers", () => {
      ...
      if (result.ok) {
        ...
        expect(result.value[0]).toEqual({ type: "literal", value: "42", position: 0 })
        expect(result.value[1]).toEqual({ type: "literal", value: "3.14", position: 3 })
        expect(result.value[2]).toEqual({ type: "literal", value: ".5", position: 8 })
      }
    })
    ...
    test("tokenizes strings", () => {
      ...
      if (result.ok) {
        ...
        expect(result.value[0]).toEqual({ type: "literal", value: '"hello"', position: 0 })
        expect(result.value[1]).toEqual({ type: "literal", value: '"world"', position: 8 })
      }
    })
    ...
    test("tokenizes cell references", () => {
      ...
      if (result.ok) {
        expect(result.value).toHaveLength(3)
        expect(result.value[0]).toEqual({ type: "cellRef", value: "A1", position: 0 })
        expect(result.value[1]).toEqual({ type: "cellRef", value: "B2", position: 3 })
        expect(result.value[2]).toEqual({ type: "cellRef", value: "AA99", position: 6 })
      }
    })
    ...
    test("tokenizes ranges", () => {
      ...
      if (result.ok) {
        expect(result.value).toHaveLength(2)
        expect(result.value[0]).toEqual({ type: "rangeRef", value: "A1:B2", position: 0 })
        expect(result.value[1]).toEqual({ type: "rangeRef", value: "C3:D4", position: 6 })
      }
    })
    ...
    test("tokenizes functions", () => {
      ...
      if (result.ok) {
        ...
        expect(result.value[0]).toEqual({ type: "function", value: "SUM", position: 0 })
        expect(result.value[1]).toEqual({ type: "parenthesis", value: "(", position: 3 })
        expect(result.value[2]).toEqual({ type: "cellRef", value: "A1", position: 4 })
        expect(result.value[3]).toEqual({ type: "parenthesis", value: ")", position: 6 })
        expect(result.value[4]).toEqual({ type: "function", value: "AVERAGE", position: 8 })
        expect(result.value[5]).toEqual({ type: "parenthesis", value: "(", position: 15 })
        expect(result.value[6]).toEqual({ type: "cellRef", value: "B2", position: 16 })
        expect(result.value[7]).toEqual({ type: "parenthesis", value: ")", position: 18 })
      }
    })
    ...
    test("tokenizes operators", () => {
      ...
      if (result.ok) {
        ...
        expect(result.value[6]).toEqual({ type: "operator", value: "<", position: 12 })
        expect(result.value[8]).toEqual({ type: "operator", value: "<=", position: 16 })
        expect(result.value[10]).toEqual({ type: "operator", value: "<>", position: 22 })
      }
    })
