...
describe('Grid', () => {
  ...
  describe('cell operations', () => {
    ...
    test('updates cell styles', () => {
      ...
      grid.updateCellStyle({ row: 0, col: 0 }, { bold: true, color: '#FF0000' });
  ...
  describe('cloning and serialization', () => {
    test('clones grid with all data', () => {
      ...
      expect(clone.getCell({ row: 0, col: 0 })).toEqual(grid.getCell({ row: 0, col: 0 }));
      expect(clone.getCell({ row: 1, col: 1 })).toEqual(grid.getCell({ row: 1, col: 1 }));
    ...
    test('deserializes from JSON', () => {
      ...
      expect(restored.getCell({ row: 0, col: 0 })).toEqual(grid.getCell({ row: 0, col: 0 }));
      expect(restored.getCell({ row: 1, col: 1 })).toEqual(grid.getCell({ row: 1, col: 1 }));
