...
describe("PivotTable", () => {
  ...
  test("supports custom aliases for value fields", () => {
    ...
    const customHeader = Array.from(output.cells.entries()).find(
      ([_key, value]) => value === "Total Revenue",
    );
