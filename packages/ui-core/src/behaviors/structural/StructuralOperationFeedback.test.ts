...
describe("StructuralOperationFeedback", () => {
  ...
  describe("initialization", () => {
    ...
    test("should create with custom styles", () => {
      ...
      const customFeedback = new StructuralOperationFeedback(container, customStyles);
      expect(mockDocument.createElement).toHaveBeenCalledWith("style");
    });
  });
  ...
  describe("event handling", () => {
    test("should handle highlightCells event", () => {
      ...
      const mockElement = {
        ...
        style: { setProperty: jest.fn(), removeProperty: jest.fn(), animation: "" }
      };
      container.querySelector.mockReturnValue(mockElement);

      feedback.handleEvent(event);

      expect(container.querySelector).toHaveBeenCalledWith('[data-row="1"][data-col="1"]');
      expect(container.querySelector).toHaveBeenCalledWith('[data-row="2"][data-col="2"]');
      expect(mockElement.classList.add).toHaveBeenCalledWith("structural-highlight-affected");
    });
    ...
    test("should handle structuralOperationCompleted event", () => {
      ...
      expect(mockElement.classList.add).toHaveBeenCalledWith("structural-highlight-affected");
      expect(mockElement.classList.add).toHaveBeenCalledWith("structural-operation-complete");
    });
    ...
    test("should handle structuralOperationFailed event", () => {
      ...
      expect(container.classList.add).toHaveBeenCalledWith("structural-operation-error");
    });
  });
  ...
  describe("cell highlighting", () => {
    test("should highlight cells with specified type", () => {
      ...
      expect(mockElement.classList.add).toHaveBeenCalledWith("structural-highlight-warning");
      expect(mockElement.style.setProperty).toHaveBeenCalledWith("--highlight-bg", expect.any(String));
      expect(mockElement.style.setProperty).toHaveBeenCalledWith("--highlight-border", expect.any(String));
  ...
  describe("style management", () => {
    test("should update highlight styles", () => {
      ...
      expect(mockDocument.getElementById).toHaveBeenCalledWith("structural-operation-feedback-styles");
    });
  ...
  describe("element interaction", () => {
    test("should apply highlight styling to cell element", () => {
      ...
      expect(mockElement.style.setProperty).toHaveBeenCalledWith("--highlight-bg", expect.any(String));
      expect(mockElement.style.setProperty).toHaveBeenCalledWith("--highlight-border", expect.any(String));
      expect(mockElement.style.setProperty).toHaveBeenCalledWith("--highlight-border-width", expect.any(String));
      expect(mockElement.style.setProperty).toHaveBeenCalledWith("--highlight-opacity", expect.any(String));
    });
    ...
    test("should remove highlight styling from cell element", () => {
      ...
      expect(mockElement.style.removeProperty).toHaveBeenCalledWith("--highlight-bg");
      expect(mockElement.style.removeProperty).toHaveBeenCalledWith("--highlight-border");
      expect(mockElement.style.removeProperty).toHaveBeenCalledWith("--highlight-border-width");
      expect(mockElement.style.removeProperty).toHaveBeenCalledWith("--highlight-opacity");
