...
test.describe("Mode Integration", () => {
  ...
  test.describe("Navigation to Editing Transitions", () => {
    test("should transition from navigation to editing with 'i' key", async ({ page }) => {
    ...
    test("should transition from navigation to editing with 'a' key (append)", async ({ page }) => {
    ...
    test("should transition from navigation to editing with Enter key", async ({ page }) => {
    ...
    test("should transition from navigation to editing with F2 key", async ({ page }) => {
    ...
    test("should transition from navigation to editing by typing", async ({ page }) => {
      ...
      await page.keyboard.press("Escape")
      await page.keyboard.press("Escape")
      await expect(page.locator(".formula-bar-input")).toHaveValue("Direct entry")
    })
  })
  ...
  test.describe("Vim Mode Transitions Within Editing", () => {
    ...
    test("should handle insert → visual → normal transitions", async ({ page }) => {
  ...
  test.describe("Edit Mode Variants", () => {
    ...
    test("should switch between edit modes within insert mode", async ({ page }) => {
      // Start editing
      await page.keyboard.press("i")
      ...
      await page.keyboard.press("Escape")
      await page.keyboard.press("Escape")
      await expect(page.locator(".formula-bar-input")).toHaveValue("test append")
    })
  })

  test.describe("Interaction Mode Integration", () => {
    test("should toggle interaction modes without affecting cell editing", async ({ page }) => {
  ...
  test.describe("Complex Mode Sequences", () => {
    test("should handle navigation → edit → visual → insert → navigation", async ({ page }) => {
      // Start in navigation
      await expect(getModeText(page)).toContainText("NAVIGATION")
    ...
    test("should maintain consistency across cell navigation during editing", async ({ page }) => {
      // Start editing in A1
      await page.keyboard.press("i")
  ...
  test.describe("Component Integration", () => {
    test("should synchronize mode indicator with actual mode state", async ({ page }) => {
    ...
    test("should handle formula bar updates during mode transitions", async ({ page }) => {
      ...
      await expect(page.locator(".formula-bar-input")).toHaveValue("World edit")
    })

    test("should handle keyboard focus correctly across modes", async ({ page }) => {
  ...
  test.describe("Debug - Understanding Mode Indicator", () => {
    test("should show current mode indicator content for debugging", async ({ page }) => {
  ...
  test.describe("Debug - Basic Editing", () => {
    test("should test basic editing and saving", async ({ page }) => {
      ...
      // Check initial value
      const initialValue = await page.locator(".formula-bar-input").inputValue()
  ...
  test.describe("Edge Cases and Error Handling", () => {
    test("should handle invalid mode transitions gracefully", async ({ page }) => {
      // Start in navigation
      await expect(getModeText(page)).toContainText("NAVIGATION")
      
      // Check if 'v' does something in navigation mode first
      // (It might start editing with 'v' character instead of visual mode)
      const initialMode = await getModeText(page).textContent()
      await page.keyboard.press("v")
    ...
    test("should handle rapid cell navigation during editing", async ({ page }) => {
      // Start editing
      await page.keyboard.press("i")
      await page.keyboard.type("test")
      await page.keyboard.press("Escape") // To normal
