...
describe("CanvasGrid Initial Load", () => {
  ...
  test("should set correct dimensions on initial load to prevent over-scrolling", () => {
    ...
    const scrollContainer = container.querySelector(".grid-scroll-container") as HTMLElement
    const spacer = scrollContainer.querySelector(".grid-spacer") as HTMLElement
    const canvas = scrollContainer.querySelector(".grid-canvas") as HTMLCanvasElement
    ...
    Object.defineProperty(scrollContainer, 'clientWidth', { value: 700, configurable: true })
...
describe("CanvasGrid Scrolling", () => {
  ...
  test("should not allow scrolling past the right edge", () => {
    ...
    Object.defineProperty(scrollContainer, 'clientWidth', { value: 700, configurable: true })
    Object.defineProperty(scrollContainer, 'clientHeight', { value: 500, configurable: true })
    Object.defineProperty(scrollContainer, 'offsetWidth', { value: 700, configurable: true })
    ...
    Object.defineProperty(scrollContainer, 'scrollWidth', { value: totalWidth, configurable: true })
  ...
  test("should not allow scrolling past the bottom edge", () => {
    ...
    Object.defineProperty(scrollContainer, 'scrollHeight', { value: totalHeight, configurable: true })
  ...
  test("headers should remain aligned when scrolled to edges", () => {
    const scrollContainer = container.querySelector(".grid-scroll-container") as HTMLElement
    const colHeaderCanvas = container.querySelector(".grid-col-header-canvas") as HTMLCanvasElement
    const rowHeaderCanvas = container.querySelector(".grid-row-header-canvas") as HTMLCanvasElement
    ...
    expect(rowHeaderTop).toBe(canvasGrid.getViewport()["theme"].columnHeaderHeight + 40)
  })
