...
export class FormulaBar {
  ...
  private setupDOM(): void {
    ...
    this.addressInput.style.cssText = `
      ...
      text-align: center;
    `;
    this.addressInput.addEventListener('keydown', this.handleAddressKeyDown.bind(this));
    ...
    this.formulaInput.addEventListener('blur', this.handleFormulaBlur.bind(this));
