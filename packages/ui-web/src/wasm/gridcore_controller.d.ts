...
export class ActionBuilder {
  private constructor();
  free(): void;
  static startEditing(initial_value?: string | null): any;
  static enterCommandMode(): any;
  static escape(): any;
  static updateCursor(col: number, row: number): any;
  static updateCommandValue(value: string): any;
}
export class EventFactory {
  private constructor();
  free(): void;
  static keyboardEvent(key: string, code: string, shift: boolean, ctrl: boolean, alt: boolean, meta: boolean): any;
  static mouseEvent(x: number, y: number, button: string, event_type: string, shift: boolean, ctrl: boolean, alt: boolean, meta: boolean): any;
  static cursorMovedEvent(from_col: number, from_row: number, to_col: number, to_row: number): any;
  static cellEditStartedEvent(col: number, row: number): any;
  static cellEditCompletedEvent(col: number, row: number, value: string): any;
  static commandExecutedEvent(command: string): any;
}
export class EventTypes {
  private constructor();
  free(): void;
  static CURSOR_MOVED(): string;
  static VIEWPORT_CHANGED(): string;
  static CELL_EDIT_STARTED(): string;
  static CELL_EDIT_COMPLETED(): string;
  static CELL_EDIT_CANCELLED(): string;
  static MODE_CHANGED(): string;
  static COMMAND_EXECUTED(): string;
}
...
export class WasmSpreadsheetController {
  free(): void;
  constructor();
  static withViewport(_viewport: any): WasmSpreadsheetController;
  getState(): any;
  dispatchAction(action_js: any): void;
  handleKeyboardEvent(event_js: any): void;
  handleMouseEvent(event_js: any): void;
  getCellValue(col: number, row: number): any;
  setCellValue(col: number, row: number, value: string): void;
  getCursor(): any;
  getViewport(): any;
  getSpreadsheetMode(): string;
  static createKeyboardEvent(key: string, shift: boolean, ctrl: boolean, alt: boolean, meta: boolean): any;
  static createMouseEvent(x: number, y: number, button: string, event_type: string): any;
  subscribe(_callback: Function): number;
  unsubscribe(_listener_id: number): boolean;
  getFacade(): any;
}
/**
...
export class WasmUIStateMachine {
  free(): void;
  constructor();
  static withInitialState(state_js: any): WasmUIStateMachine;
  getState(): any;
  transition(action_js: any): void;
  getSpreadsheetMode(): string;
  getCursor(): any;
  getViewport(): any;
  getHistory(): any;
  clearHistory(): void;
  startEditing(initial_value?: string | null): void;
...
export class WasmViewportManager {
  free(): void;
  constructor(total_rows: number, total_cols: number);
  ...
  setScrollCallback(callback: Function): void;
  ensureVisible(col: number, row: number): void;
  viewportToCell(x: number, y: number): any;
}
/**
...
export interface InitOutput {
  ...
  readonly __wbg_wasmspreadsheetcontroller_free: (a: number, b: number) => void;
  readonly wasmspreadsheetcontroller_new: () => number;
  readonly wasmspreadsheetcontroller_withViewport: (a: number, b: number) => void;
  readonly wasmspreadsheetcontroller_getState: (a: number, b: number) => void;
  readonly wasmspreadsheetcontroller_dispatchAction: (a: number, b: number, c: number) => void;
  readonly wasmspreadsheetcontroller_handleKeyboardEvent: (a: number, b: number, c: number) => void;
  readonly wasmspreadsheetcontroller_handleMouseEvent: (a: number, b: number, c: number) => void;
  readonly wasmspreadsheetcontroller_getCellValue: (a: number, b: number, c: number, d: number) => void;
  readonly wasmspreadsheetcontroller_setCellValue: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly wasmspreadsheetcontroller_getCursor: (a: number, b: number) => void;
  readonly wasmspreadsheetcontroller_getViewport: (a: number, b: number) => void;
  readonly wasmspreadsheetcontroller_getSpreadsheetMode: (a: number, b: number) => void;
  readonly wasmspreadsheetcontroller_createKeyboardEvent: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly wasmspreadsheetcontroller_createMouseEvent: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly wasmspreadsheetcontroller_subscribe: (a: number, b: number) => number;
  readonly wasmspreadsheetcontroller_unsubscribe: (a: number, b: number) => number;
  readonly wasmspreadsheetcontroller_getFacade: (a: number, b: number) => void;
  readonly eventfactory_keyboardEvent: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
  readonly eventfactory_mouseEvent: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => void;
  readonly eventfactory_cursorMovedEvent: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly eventfactory_cellEditStartedEvent: (a: number, b: number, c: number) => void;
  readonly eventfactory_cellEditCompletedEvent: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly eventfactory_commandExecutedEvent: (a: number, b: number, c: number) => void;
  readonly eventtypes_CURSOR_MOVED: (a: number) => void;
  readonly eventtypes_VIEWPORT_CHANGED: (a: number) => void;
  readonly eventtypes_CELL_EDIT_STARTED: (a: number) => void;
  readonly eventtypes_CELL_EDIT_COMPLETED: (a: number) => void;
  readonly eventtypes_CELL_EDIT_CANCELLED: (a: number) => void;
  readonly eventtypes_MODE_CHANGED: (a: number) => void;
  readonly eventtypes_COMMAND_EXECUTED: (a: number) => void;
  readonly mousebuttons_LEFT: (a: number) => void;
  readonly mousebuttons_MIDDLE: (a: number) => void;
  readonly mousebuttons_RIGHT: (a: number) => void;
  readonly mousebuttons_NONE: (a: number) => void;
  readonly mouseeventtypes_DOWN: (a: number) => void;
  readonly mouseeventtypes_UP: (a: number) => void;
  readonly mouseeventtypes_MOVE: (a: number) => void;
  readonly mouseeventtypes_CLICK: (a: number) => void;
  readonly mouseeventtypes_DOUBLE_CLICK: (a: number) => void;
  readonly mouseeventtypes_WHEEL: (a: number) => void;
  readonly __wbg_wasmuistatemachine_free: (a: number, b: number) => void;
  readonly wasmuistatemachine_new: () => number;
  readonly wasmuistatemachine_withInitialState: (a: number, b: number) => void;
  readonly wasmuistatemachine_getState: (a: number, b: number) => void;
  readonly wasmuistatemachine_transition: (a: number, b: number, c: number) => void;
  readonly wasmuistatemachine_getSpreadsheetMode: (a: number, b: number) => void;
  readonly wasmuistatemachine_getCursor: (a: number, b: number) => void;
  readonly wasmuistatemachine_getViewport: (a: number, b: number) => void;
  readonly wasmuistatemachine_getHistory: (a: number, b: number) => void;
  readonly wasmuistatemachine_clearHistory: (a: number) => void;
  readonly wasmuistatemachine_startEditing: (a: number, b: number, c: number, d: number) => void;
  readonly wasmuistatemachine_enterCommandMode: (a: number, b: number) => void;
  readonly wasmuistatemachine_escape: (a: number, b: number) => void;
  readonly wasmuistatemachine_updateCursor: (a: number, b: number, c: number, d: number) => void;
  readonly __wbg_actionbuilder_free: (a: number, b: number) => void;
  readonly actionbuilder_startEditing: (a: number, b: number, c: number) => void;
  readonly actionbuilder_enterCommandMode: (a: number) => void;
  readonly actionbuilder_escape: (a: number) => void;
  readonly actionbuilder_updateCursor: (a: number, b: number, c: number) => void;
  readonly actionbuilder_updateCommandValue: (a: number, b: number, c: number) => void;
  readonly __wbg_wasmviewportmanager_free: (a: number, b: number) => void;
  readonly wasmviewportmanager_new: (a: number, b: number) => number;
  readonly wasmviewportmanager_getColumnWidth: (a: number, b: number) => number;
  readonly wasmviewportmanager_setColumnWidth: (a: number, b: number, c: number) => void;
  readonly wasmviewportmanager_getRowHeight: (a: number, b: number) => number;
  readonly wasmviewportmanager_setRowHeight: (a: number, b: number, c: number) => void;
  readonly wasmviewportmanager_getTotalRows: (a: number) => number;
  readonly wasmviewportmanager_getTotalCols: (a: number) => number;
  readonly wasmviewportmanager_scrollTo: (a: number, b: number, c: number) => void;
  readonly wasmviewportmanager_setScrollCallback: (a: number, b: number) => void;
  readonly wasmviewportmanager_ensureVisible: (a: number, b: number, c: number) => void;
  readonly wasmviewportmanager_viewportToCell: (a: number, b: number, c: number) => number;
  readonly init: () => void;
  readonly version: (a: number) => void;
  readonly __wbg_mousebuttons_free: (a: number, b: number) => void;
  readonly __wbg_eventtypes_free: (a: number, b: number) => void;
  readonly __wbg_mouseeventtypes_free: (a: number, b: number) => void;
  readonly __wbg_eventfactory_free: (a: number, b: number) => void;
