...
export const __wbg_wasmspreadsheetcontroller_free: (a: number, b: number) => void;
export const wasmspreadsheetcontroller_new: () => number;
export const wasmspreadsheetcontroller_withViewport: (a: number, b: number) => void;
export const wasmspreadsheetcontroller_getState: (a: number, b: number) => void;
export const wasmspreadsheetcontroller_dispatchAction: (a: number, b: number, c: number) => void;
export const wasmspreadsheetcontroller_handleKeyboardEvent: (a: number, b: number, c: number) => void;
export const wasmspreadsheetcontroller_handleMouseEvent: (a: number, b: number, c: number) => void;
export const wasmspreadsheetcontroller_getCellValue: (a: number, b: number, c: number, d: number) => void;
export const wasmspreadsheetcontroller_setCellValue: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
export const wasmspreadsheetcontroller_getCursor: (a: number, b: number) => void;
export const wasmspreadsheetcontroller_getViewport: (a: number, b: number) => void;
export const wasmspreadsheetcontroller_getSpreadsheetMode: (a: number, b: number) => void;
export const wasmspreadsheetcontroller_createKeyboardEvent: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
export const wasmspreadsheetcontroller_createMouseEvent: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
export const wasmspreadsheetcontroller_subscribe: (a: number, b: number) => number;
export const wasmspreadsheetcontroller_unsubscribe: (a: number, b: number) => number;
export const wasmspreadsheetcontroller_getFacade: (a: number, b: number) => void;
export const eventfactory_keyboardEvent: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
export const eventfactory_mouseEvent: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => void;
export const eventfactory_cursorMovedEvent: (a: number, b: number, c: number, d: number, e: number) => void;
export const eventfactory_cellEditStartedEvent: (a: number, b: number, c: number) => void;
export const eventfactory_cellEditCompletedEvent: (a: number, b: number, c: number, d: number, e: number) => void;
export const eventfactory_commandExecutedEvent: (a: number, b: number, c: number) => void;
export const eventtypes_CURSOR_MOVED: (a: number) => void;
export const eventtypes_VIEWPORT_CHANGED: (a: number) => void;
export const eventtypes_CELL_EDIT_STARTED: (a: number) => void;
export const eventtypes_CELL_EDIT_COMPLETED: (a: number) => void;
export const eventtypes_CELL_EDIT_CANCELLED: (a: number) => void;
export const eventtypes_MODE_CHANGED: (a: number) => void;
export const eventtypes_COMMAND_EXECUTED: (a: number) => void;
export const mousebuttons_LEFT: (a: number) => void;
export const mousebuttons_MIDDLE: (a: number) => void;
export const mousebuttons_RIGHT: (a: number) => void;
export const mousebuttons_NONE: (a: number) => void;
export const mouseeventtypes_DOWN: (a: number) => void;
export const mouseeventtypes_UP: (a: number) => void;
export const mouseeventtypes_MOVE: (a: number) => void;
export const mouseeventtypes_CLICK: (a: number) => void;
export const mouseeventtypes_DOUBLE_CLICK: (a: number) => void;
export const mouseeventtypes_WHEEL: (a: number) => void;
export const __wbg_wasmuistatemachine_free: (a: number, b: number) => void;
export const wasmuistatemachine_new: () => number;
export const wasmuistatemachine_withInitialState: (a: number, b: number) => void;
export const wasmuistatemachine_getState: (a: number, b: number) => void;
export const wasmuistatemachine_transition: (a: number, b: number, c: number) => void;
export const wasmuistatemachine_getSpreadsheetMode: (a: number, b: number) => void;
export const wasmuistatemachine_getCursor: (a: number, b: number) => void;
export const wasmuistatemachine_getViewport: (a: number, b: number) => void;
export const wasmuistatemachine_getHistory: (a: number, b: number) => void;
export const wasmuistatemachine_clearHistory: (a: number) => void;
export const wasmuistatemachine_startEditing: (a: number, b: number, c: number, d: number) => void;
export const wasmuistatemachine_enterCommandMode: (a: number, b: number) => void;
export const wasmuistatemachine_escape: (a: number, b: number) => void;
export const wasmuistatemachine_updateCursor: (a: number, b: number, c: number, d: number) => void;
export const __wbg_actionbuilder_free: (a: number, b: number) => void;
export const actionbuilder_startEditing: (a: number, b: number, c: number) => void;
export const actionbuilder_enterCommandMode: (a: number) => void;
export const actionbuilder_escape: (a: number) => void;
export const actionbuilder_updateCursor: (a: number, b: number, c: number) => void;
export const actionbuilder_updateCommandValue: (a: number, b: number, c: number) => void;
export const __wbg_wasmviewportmanager_free: (a: number, b: number) => void;
export const wasmviewportmanager_new: (a: number, b: number) => number;
export const wasmviewportmanager_getColumnWidth: (a: number, b: number) => number;
export const wasmviewportmanager_setColumnWidth: (a: number, b: number, c: number) => void;
export const wasmviewportmanager_getRowHeight: (a: number, b: number) => number;
export const wasmviewportmanager_setRowHeight: (a: number, b: number, c: number) => void;
export const wasmviewportmanager_getTotalRows: (a: number) => number;
export const wasmviewportmanager_getTotalCols: (a: number) => number;
export const wasmviewportmanager_scrollTo: (a: number, b: number, c: number) => void;
export const wasmviewportmanager_setScrollCallback: (a: number, b: number) => void;
export const wasmviewportmanager_ensureVisible: (a: number, b: number, c: number) => void;
export const wasmviewportmanager_viewportToCell: (a: number, b: number, c: number) => number;
export const init: () => void;
export const version: (a: number) => void;
export const __wbg_mousebuttons_free: (a: number, b: number) => void;
export const __wbg_eventtypes_free: (a: number, b: number) => void;
export const __wbg_mouseeventtypes_free: (a: number, b: number) => void;
export const __wbg_eventfactory_free: (a: number, b: number) => void;
