...
import { createNavigationState, isEditingMode, isResizeMode } from "@gridcore/ui-core"
...
describe("SpreadsheetTUI Controller Integration", () => {
  ...
  describe("Navigation Mode", () => {
    ...
    test("should handle arrow key navigation", () => {
      ...
      // Simulate down arrow
      tui["handleKeyPress"]("j", { ctrl: false, alt: false, shift: false, key: "j" })
      const afterDown = tui.getState()
      expect(afterDown.cursor).toEqual({ row: 1, col: 1 })
    })

    test("should enter edit mode with 'i' key", () => {
      tui["handleKeyPress"]("i", { ctrl: false, alt: false, shift: false, key: "i" })
      const state = tui.getState()
    ...
    test("should enter command mode with ':' key", () => {
      tui["handleKeyPress"](":", { ctrl: false, alt: false, shift: false, key: ":" })
      const state = tui.getState()
  ...
  describe("Edit Mode", () => {
    ...
    test("should track editing value", () => {
      ...
      // Type "hello"
      tui["handleKeyPress"]("h", { ctrl: false, alt: false, shift: false, key: "h" })
      tui["handleKeyPress"]("e", { ctrl: false, alt: false, shift: false, key: "e" })
      tui["handleKeyPress"]("l", { ctrl: false, alt: false, shift: false, key: "l" })
      tui["handleKeyPress"]("l", { ctrl: false, alt: false, shift: false, key: "l" })
      tui["handleKeyPress"]("o", { ctrl: false, alt: false, shift: false, key: "o" })
    ...
    test("should handle backspace", () => {
      // Type "test"
      tui["handleKeyPress"]("t", { ctrl: false, alt: false, shift: false, key: "t" })
      tui["handleKeyPress"]("e", { ctrl: false, alt: false, shift: false, key: "e" })
      tui["handleKeyPress"]("s", { ctrl: false, alt: false, shift: false, key: "s" })
      tui["handleKeyPress"]("t", { ctrl: false, alt: false, shift: false, key: "t" })
      
      // Backspace
      tui["handleKeyPress"]("\b", { ctrl: false, alt: false, shift: false, key: "backspace" })
  ...
  describe("Command Mode", () => {
    ...
    test("should track command input", () => {
      tui["handleKeyPress"]("w", { ctrl: false, alt: false, shift: false, key: "w" })
      const state = tui.getState()
      expect(state.commandValue).toBe("w")
    })

    test("should exit command mode with ESC", () => {
      tui["handleKeyPress"]("q", { ctrl: false, alt: false, shift: false, key: "q" })
      tui["handleKeyPress"]("\x1b", { ctrl: false, alt: false, shift: false, key: "escape" })
