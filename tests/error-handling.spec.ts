...
test.describe("Error Handling", () => {
  ...
  test.describe("Formula Errors", () => {
    ...
    test("should handle circular reference error", async ({ page }) => {
      ...
      const errorMessages = await getErrorMessages(page)
      expect(errorMessages.some(msg => msg.toLowerCase().includes("circular"))).toBeTruthy()
    })
  })

  test.describe("Error Display UI", () => {
    test("should show error messages with correct severity styling", async ({ page }) => {
      // Trigger an error
    ...
    test("should auto-dismiss info messages after 5 seconds", async ({ page }) => {
  ...
  test.describe("Error Recovery", () => {
    test("should exit editing mode even with invalid formula", async ({ page }) => {
      // Start editing
  ...
  test.describe("Error Propagation", () => {
    test("should handle formulas referencing cells with errors", async ({ page }) => {
